                          ...
                          ?>
                            <div class="col-sm-6 col-md-4 col-lg-4 mb-3">
                              <div class="card h-100">
                                <?php
                                if ($prod->prod_img) {
                                  echo "<img src='../admin/assets/img/products/$prod->prod_img' class='card-img-top' alt='$prod->prod_name'>";
                                } else {
                                  echo "<img src='../admin/assets/img/products/default.jpg' class='card-img-top' alt='Default Image'>";
                                }
                                ?>
